...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Xo(e,t,n){let r=new Float32Array(Io),i=new K(0,1,0);return new Sa({name:`SphericalGaussianBlur`,defines:{n:Io,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:$o(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Zo(){return new Sa({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:$o(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Qo(){return new Sa({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:$o(),fragmentShader:`
	...
	`}var es=class extends zn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new sa(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var Tc={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function Ec(e,t){let n=Tc[t];return n===void 0?(H(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var Dc=new K;function Oc(){return J.getLuminanceCoefficients(Dc),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${Dc.x.toFixed(4)}, ${Dc.y.toFixed(4)}, ${Dc.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=_c(i,i.VERTEX_SHADER,y),S=_c(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1){if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=Cc(i,x,`vertex`),n=Cc(i,S,`fragment`);U(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
`))}}function su(e){let t=new wa({color:16513006,roughness:.3,metalness:0,map:e??null}),n={value:-1};ou(t,n);let r=new wa({color:16777215,roughness:.42,metalness:0,vertexColors:!0}),i=new wa({color:11564598,roughness:.55,metalness:0}),a=Zl(),o=new Oi({color:0,map:a,transparent:!0,opacity:.34,depthWrite:!1}),s=!1,c=e;return{face:t,body:r,back:i,shadow:o,setShimmer(e){n.value=e},setFaceMap(e){if(s){e.dispose();return}c?.dispose(),c=e,t.map=e,t.needsUpdate=!0},dispose(){s||(s=!0,t.dispose(),r.dispose(),i.dispose(),o.dispose(),a.dispose(),c?.dispose())}}}var cu=e=>`${e.kind.suit}${e.kind.rank}`,lu=(e,t)=>(e.pos.x-t.pos.x)**2+(e.pos.y-t.pos.y)**2+(e.pos.z-t.pos.z)**2,uu=(e,t)=>e.pos.x===t.pos.x&&e.pos.y===t.pos.y&&e.pos.z===t.pos.z&&e.rot.x===t.rot.x&&e.rot.y===t.rot.y&&e.rot.z===t.rot.z&&e.faceUp===t.faceUp&&(e.dim??!1)===(t.dim??!1)&&(e.grounded??!0)===(t.grounded??!0)&&(e.won??!1)===(t.won??!1)&&(e.seen??!1)===(t.seen??!1)&&(e.lock??!1)===(t.lock??!1)&&(e.scale??1)===(t.scale??1),du=(e,t)=>!(e.zone===`drawn`&&t.zone===`hand`||e.zone===`hand`&&t.zone===`drawn`);function fu(e,t){if(e===null)return{enter:[...t.tiles],move:[],exit:[]};let n=new Map(e.tiles.map(e=>[e.key,e])),r=[],i=[],a=new Set,o=e=>`${e.seat}:${e.zone}`,s=new Set;for(let e of t.tiles){let t=n.get(e.key);t!==void 0&&t.faceUp&&e.faceUp&&cu(t)!==cu(e)&&s.add(o(e))}for(let e of t.tiles){let t=n.get(e.key);if(t===void 0||cu(t)!==cu(e)){i.push(e);continue}if(t.faceUp&&e.faceUp&&s.has(o(e))){i.push(e);continue}a.add(t.key),uu(t,e)||r.push({from:t,to:e})}let c=e.tiles.filter(e=>!a.has(e.key)),l=new Map,u=[];for(let e of c){if(!e.faceUp){u.push(e);continue}let t=cu(e),n=l.get(t);n===void 0?l.set(t,[e]):n.push(e)}let d=[];for(let e of i){let t=e.faceUp?l.get(cu(e)):void 0,n=-1,i=1/0;if(t!==void 0)for(let r=0;r<t.length;r++){if(!du(t[r],e))continue;let a=lu(t[r],e);a<i&&(i=a,n=r)}if(t===void 0||n<0){d.push(e);continue}let a=t.splice(n,1)[0];(!uu(a,e)||s.has(o(e)))&&r.push({from:a,to:e})}for(let e of l.values())u.push(...e);return{enter:d,move:r,exit:u}}var pu=(e,t)=>e.tiles.filter(e=>e.seat===t&&(e.zone===`hand`||e.zone===`drawn`)),mu=(e,t)=>Math.abs(e.x-t.x)<1e-9&&Math.abs(e.y-t.y)<1e-9&&Math.abs(e.z-t.z)<1e-9;function hu(e,t){let n=be(e);if(mu(t.from.rot,O(n,a))&&mu(t.to.rot,O(n,r)))return{yaw:n,from:a,to:r}}function gu(e,t){if(e.length!==t.length)return null;if(!e.some(e=>e.faceUp))return e.map((e,n)=>({from:e,to:t[n]}));let n=[...e],r=[];for(let e of t){let t=n.findIndex(t=>t.kind.suit===e.kind.suit&&t.kind.rank===e.kind.rank);if(t<0)return null;r.push({from:n.splice(t,1)[0],to:e})}return R(r)}function _u(e,t,n,r,i){if(!(r>0))return null;let a=[];for(let r of new Set(n)){let n=gu(pu(e,r),pu(t,r));if(n===null)return null;for(let e of n){let t=hu(r,e);a.push({from:e.from,to:e.to,startMs:i,durMs:600,...t===void 0?{}:{spin:t}})}}return{tracks:a,endMs:a.reduce((e,t)=>Math.max(e,t.startMs+t.durMs),i)}}function vu(e,t){return e.flatMap(e=>{if(t>=e.startMs+e.durMs)return[];let n=se(e,t);return[{...e,from:j(e,t),startMs:t,durMs:140,...n===void 0?{}:{spin:n}}]})}function yu(e,t){let n=0,r=0,i=0;for(let a of e)t<a.startMs?n++:t<a.startMs+a.durMs?r++:i++;return{planned:e.length,pending:n,flying:r,landed:i}}var bu=2;function xu(e,t){let n=ge(t);if(e instanceof eo){let n=s(t),r=n/t.aspect;e.left=-n,e.right=n,e.top=r,e.bottom=-r}else e.fov=ue(t);e.up.set(n.up.x,n.up.y,n.up.z),e.position.set(n.pos.x,n.pos.y,n.pos.z),e.lookAt(n.target.x,n.target.y,n.target.z),e.updateProjectionMatrix(),e.updateMatrixWorld(!0)}function Su(e,t,n,r){let i=(e,t)=>r===void 0?c(e/t):{...r,aspect:e/t},a=i(t.w,t.h),o=new Cr;o.background=new X(1053979);let s=e=>e.mode===`2d`?new eo(-1,1,1,-1,1,500):new $a(ue(e),e.aspect,1,500),l=s(a);xu(l,a),o.add(new ro(16777215,.55));let u=new no(16777215,1.1);u.position.set(-40,90,60),o.add(u);let d=ru();o.environment=d;let f=n?.makeRenderer()??new Rl({antialias:!0,alpha:!1});f.setPixelRatio?.(Math.min(T(),bu)),f.setSize(t.w,t.h,!1),e.appendChild(f.domElement);let p=!1;return{scene:o,renderer:f,environment:d,get camera(){return l},get view(){return a},render(){p||f.render(o,l)},resize(e,t){if(p)return;let n=i(e,t);n.mode!==a.mode&&(l=s(n)),a=n,l instanceof $a&&(l.aspect=a.aspect),xu(l,a),f.setSize(e,t,!1)},dispose(){p||(p=!0,o.environment=null,d.dispose(),f.forceContextLoss?.(),f.dispose(),f.domElement.remove())}}}var Cu=1024,$=e=>e*Cu/20,wu={body:`#232b33`,bodyEdge:`#4a5866`,bevel:`#5f7183`,display:`#0f1418`,displayEdge:`#33424f`,round:`#7fe3ff`,remaining:`#eaf6ff`,status:`#8ea0b0`,score:`#f0c860`,scoreActive:`#ffffff`,wind:`#c9d6e0`,windDealer:`#ff8b4a`,turnBar:`#4ff0a5`},Tu=`system-ui, -apple-system, "Segoe UI", Roboto, sans-serif`;function Eu(e,t,n,r,i){let a=r;for(let r=0;r<12&&(e.font=`${i} ${a}px ${Tu}`,!(e.measureText(t).width<=n));r++)a*=.92;return a}function Du(e,t,n,r,i,a){e.beginPath(),e.moveTo(t+a,n),e.arcTo(t+r,n,t+r,n+i,a),e.arcTo(t+r,n+i,t,n+i,a),e.arcTo(t,n+i,t,n,a),e.arcTo(t,n,t+r,n,a),e.closePath()}var Ou=[0,-Math.PI/2,Math.PI,Math.PI/2],ku={x:3.5,y:5.9,w:13,h:8.2},Au=7.6;function ju(e,t){let n=Cu;e.clearRect(0,0,n,n),e.textAlign=`center`,e.textBaseline=`middle`,Du(e,$(.15),$(.15),$(19.7),$(19.7),$(1.6)),e.fillStyle=wu.body,e.fill(),e.lineWidth=$(.3),e.strokeStyle=wu.bodyEdge,e.stroke(),Du(e,$(.75),$(.75),$(18.5),$(18.5),$(1.1)),e.lineWidth=$(.08),e.strokeStyle=wu.bevel,e.stroke(),Du(e,$(ku.x),$(ku.y),$(ku.w),$(ku.h),$(.9)),e.fillStyle=wu.display,e.fill(),e.lineWidth=$(.1),e.strokeStyle=wu.displayEdge,e.stroke();let r=$(ku.w-1.4);e.fillStyle=wu.round,e.font=`600 ${Eu(e,t.round,r,$(1.35),`600`)}px ${Tu}`,e.fillText(t.round,$(10),$(7.35)),e.fillStyle=wu.remaining,e.font=`700 ${Eu(e,t.remainingRef,r,$(2.45),`700`)}px ${Tu}`,e.fillText(t.remaining,$(10),$(10)),e.fillStyle=wu.status,e.font=`500 ${Eu(e,t.status,r,$(1.15),`500`)}px ${Tu}`,e.fillText(t.status,$(10),$(12.6));for(let n of t.seats){e.save(),e.translate($(10),$(10)),e.rotate(Ou[n.side]);let t=$(Au),r=`${n.score}${n.riichi?` ●`:``}`,i=Eu(e,r,$(7.2),$(1.9),`700`);e.font=`700 ${i}px ${Tu}`;let a=e.measureText(r).width,o=$(1.6);e.font=`600 ${o}px ${Tu}`;let s=e.measureText(n.wind).width,c=$(.6),l=-(s+c+a)/2;n.turn&&(Du(e,l-$(.7),t-$(1.35),s+c+a+$(1.4),$(2.7),$(1.35)),e.fillStyle=wu.turnBar,e.globalAlpha=.18,e.fill(),e.globalAlpha=1,e.lineWidth=$(.1),e.strokeStyle=wu.turnBar,e.stroke()),e.fillStyle=n.dealer?wu.windDealer:wu.wind,e.font=`600 ${o}px ${Tu}`,e.fillText(n.wind,l+s/2,t),e.fillStyle=n.turn?wu.scoreActive:wu.score,e.font=`700 ${i}px ${Tu}`,e.fillText(r,l+s+c+a/2,t),e.restore()}}function Mu(){let e=new pa(d.half*2,d.half*2);e.rotateX(-Math.PI/2);let t=new Oi({transparent:!0,depthWrite:!0}),n=new Bi(e,t);n.position.set(0,d.y,0),n.frustumCulled=!1,n.visible=!1;let r=null,i=null,a=!1,o=!1;return{object:n,update(e){if(o||a)return;let s=A(e);if(s!==i)try{let a=document.createElement(`canvas`);a.width=Cu,a.height=Cu;let o=a.getContext(`2d`);if(o===null)throw Error(`점수판 2d 컨텍스트를 못 얻었다`);ju(o,e);let c=new ca(a);c.colorSpace=qt,c.generateMipmaps=!0,c.anisotropy=8,r?.dispose(),r=c,t.map=c,t.needsUpdate=!0,n.visible=!0,i=s}catch(e){a=!0,console.error(`[board3d] 점수판 굽기 실패`,e)}},dispose(){o||(o=!0,e.dispose(),t.dispose(),r?.dispose(),r=null)}}}var Nu=`riichi-stick`,Pu=C.w*(2/3)/2,Fu=24;function Iu(e,t,n,r,i,a,o,s){let c=(e,t)=>[r[0]+e*i[0]+t*a[0],r[1]+e*i[1]+t*a[1],r[2]+e*i[2]+t*a[2]],l=c(-1,-1),u=c(1,-1),d=c(1,1),f=c(-1,1);for(let r of[l,u,d,l,d,f])e.push(r[0],r[1],r[2]),t.push(o[0],o[1],o[2]),n.push(s.r,s.g,s.b)}function Lu(e,t,n,r,i,a,o,s){for(let c of[r,i,a])e.push(c[0],c[1],c[2]),t.push(o[0],o[1],o[2]),n.push(s.r,s.g,s.b)}function Ru(){let e=C.len/2,t=C.w/2,n=C.d/2,r=[],i=[],a=[],o=Jl.body,s=Jl.dot,c=[0,0,1],l=Math.atan2(t,e),u=e=>(e%(2*Math.PI)+2*Math.PI)%(2*Math.PI),d=[...new Set([...Array.from({length:Fu},(e,t)=>2*Math.PI*t/Fu),...[l,Math.PI-l,Math.PI+l,-l].map(u)].map(e=>Number(u(e).toFixed(9))))].sort((e,t)=>e-t),f=r=>{let i=Math.cos(r),a=Math.sin(r),o=Math.min(Math.abs(i)<1e-9?1/0:e/Math.abs(i),Math.abs(a)<1e-9?1/0:t/Math.abs(a));return[o*i,o*a,n]},p=e=>[Pu*Math.cos(e),Pu*Math.sin(e),n];for(let e=0;e<d.length;e++){let t=d[e],l=d[(e+1)%d.length];Lu(r,i,a,[0,0,n],p(t),p(l),c,s),Lu(r,i,a,p(t),f(t),f(l),c,o),Lu(r,i,a,p(t),f(l),p(l),c,o)}Iu(r,i,a,[0,0,-n],[0,t,0],[e,0,0],[0,0,-1],o),Iu(r,i,a,[e,0,0],[0,t,0],[0,0,n],[1,0,0],o),Iu(r,i,a,[-e,0,0],[0,0,n],[0,t,0],[-1,0,0],o),Iu(r,i,a,[0,t,0],[0,0,n],[e,0,0],[0,1,0],o),Iu(r,i,a,[0,-t,0],[e,0,0],[0,0,n],[0,-1,0],o);let m=new _i;return m.setAttribute(`position`,new ni(new Float32Array(r),3)),m.setAttribute(`normal`,new ni(new Float32Array(i),3)),m.setAttribute(`color`,new ni(new Float32Array(a),3)),m}function zu(e){let t=Ru(),n=new Qi(t,e.body,4);n.name=Nu,n.count=4,n.frustumCulled=!1;let r=new Y,i=new bn,a=new K,o=new Zn,s=new K(1,1,1),c=!1,l=e=>{n.setMatrixAt(e,r.makeScale(0,0,0))};for(let e=0;e<4;e++)l(e);return n.instanceMatrix.needsUpdate=!0,{object:n,update(e){if(!c){if(e.length>4)throw Error(`리치봉 자리 초과: ${e.length} > 4`);for(let t=0;t<4;t++){let c=e[t];if(c===void 0){l(t);continue}o.set(c.rot.x,c.rot.y,c.rot.z),i.setFromEuler(o),a.set(c.pos.x,c.pos.y,c.pos.z),n.setMatrixAt(t,r.compose(a,i,s))}n.instanceMatrix.needsUpdate=!0}},dispose(){c||(c=!0,t.dispose(),n.dispose())}}}var Bu=2*L;function Vu(e){let t=[];return e.players.forEach((e,n)=>{let r=e.riichiDiscardIndex;r===void 0||r<0||r>=e.discards.length||t.push({seat:n,key:Ee(n,r)})}),t}function Hu(e,t,n,r,i,a,o){let s=new Set(t.map(e=>e.key)),c=n.filter(e=>s.has(e.key)&&!qu(e,i));if(e===null||a<=0&&o<=0)return c;let l=new Set(e),u=new Set(c.map(e=>e.key)),d=t.filter(e=>!l.has(e.key)&&!u.has(e.key)).map(e=>({key:e.key,seat:e.seat,startMs:i,landMs:r(e.key),pushMs:a,rippleMs:o}));return[...c,...d]}function Uu(e,t){return e.pushMs<=0||t>=e.landMs+e.pushMs?0:t>=e.landMs?Bu*(1-fe((t-e.landMs)/e.pushMs)):t<=e.startMs?0:Bu*fe((t-e.startMs)/(e.landMs-e.startMs))}function Wu(e,t,n){return Ku(e,t.seat,Uu(t,n))}var Gu=e=>e.landMs+e.pushMs;function Ku(e,t,n){if(n===0)return e;let r=p(t,{x:n,y:0,z:0});return{...e,pos:{x:e.pos.x+r.x,y:e.pos.y+r.y,z:e.pos.z+r.z}}}function qu(e,t){return t>=Gu(e)+e.rippleMs}function Ju(e,t){return e.every(e=>qu(e,t))}var Yu=P.half/5,Xu=M.w,Zu=1.5;function Qu(e,t){if(e.rippleMs<=0)return null;let n=(t-Gu(e))/e.rippleMs;return n<0||n>=1?null:{radiusCm:Xu+(Yu-Xu)*Ce(n),glow:(1-n)**Zu}}var $u=`riichi-ripple`,ed=.05,td=new X(16773854),nd=128,rd=.82,id=.11,ad=.045;function od(){let e=new Uint8Array(65536);for(let t=0;t<nd;t++)for(let n=0;n<nd;n++){let r=(n+.5)/nd*2-1,i=(t+.5)/nd*2-1,a=Math.hypot(r,i),o=a<rd?id:ad,s=(a-rd)/o,c=a>1?0:Math.exp(-s*s),l=(t*nd+n)*4;e[l]=255,e[l+1]=255,e[l+2]=255,e[l+3]=Math.round(Math.max(0,Math.min(1,c))*255)}let t=new Ui(e,nd,nd,Xe);return t.colorSpace=qt,t.minFilter=Me,t.magFilter=Me,t.needsUpdate=!0,t}function sd(){let e=od(),t=new Oi({color:td,map:e,transparent:!0,blending:2,depthWrite:!1}),n=new pa(1,1),r=new Qi(n,t,4);r.name=$u,r.count=4,r.frustumCulled=!1,r.renderOrder=2;let i=new Y,a=new bn().setFromEuler(new Zn(-Math.PI/2,0,0)),o=new K,s=new K,c=new X,l=!1,u=e=>{r.setMatrixAt(e,i.makeScale(0,0,0))};for(let e=0;e<4;e++)u(e),r.setColorAt(e,c.setRGB(0,0,0));return r.instanceMatrix.needsUpdate=!0,r.instanceColor!==null&&(r.instanceColor.needsUpdate=!0),{object:r,update(e){if(!l){if(e.length>4)throw Error(`파문 자리 초과: ${e.length} > 4`);for(let t=0;t<4;t++){let n=e[t];if(n===void 0){u(t);continue}o.set(n.x,ed,n.z),s.set(n.radiusCm*2,n.radiusCm*2,1),r.setMatrixAt(t,i.compose(o,a,s)),r.setColorAt(t,c.copy(td).multiplyScalar(Math.max(0,Math.min(1,n.glow))))}r.instanceMatrix.needsUpdate=!0,r.instanceColor!==null&&(r.instanceColor.needsUpdate=!0)}},dispose(){l||(l=!0,n.dispose(),t.dispose(),e.dispose(),r.dispose())}}}var cd=380,ld=e=>1-(1-e)**3,ud=(e,t)=>Math.min(1,Math.max(0,(t-e.startMs)/cd));function dd(e,t,n,r){let i=new Set(t.map(e=>e.key)),a=n.filter(e=>i.has(e.key)&&r<e.startMs+cd);if(e===null)return a;let o=new Set(e.map(e=>e.key)),s=new Set(a.map(e=>e.key)),c=t.filter(e=>!o.has(e.key)&&!s.has(e.key)).map(e=>({key:e.key,seat:e.seat,startMs:r}));return[...a,...c]}function fd(e,t,n){if(t.length===0)return[...e];let r=new Map(t.map(e=>[e.key,e]));return e.map(e=>{let t=r.get(e.key);if(t===void 0)return e;let i=ud(t,n);return{...e,...l(e.seat,ld(i),i)}})}function pd(e,t){return e.every(e=>t>=e.startMs+cd)}var md=3111514,hd=1.18,gd=e=>e<=.04045?e/12.92:((e+.055)/1.055)**2.4,_d=e=>e<=.0031308?e*12.92:1.055*e**(1/2.4)-.055;function vd(e){let t=0;for(let n of[16,8,0]){let r=gd((e>>n&255)/255),i=Math.round(255*_d(Math.min(1,r*hd)));t|=Math.max(0,Math.min(255,i))<<n}return t}vd(md);var yd=M.w*3/32,bd=.01,xd=[0,1,2,3],Sd=M.d/2,Cd=_.halfX+Sd,wd=_.zFar-Sd,Td=_.zNear+Sd,Ed=D(d.half),Dd=d.half,Od=Ed-(Ed-Dd)/2;function kd(){let e=Cd,t=wd,n=Td,r=Ed,i=Od,a=Dd,o=[];for(let r of xd){let i=(e,t)=>{let n=p(r,{x:e,y:0,z:t});return{x:n.x,z:n.z}},a=[i(-e,t),i(-e,n),i(e,n),i(e,t)];for(let e=0;e<4;e++)o.push({a:a[e],b:a[(e+1)%4]})}let s=e=>({x:-e.z,z:e.x}),c=[{x:r,z:i},{x:i,z:i},{x:i,z:r}],l=[];for(let e=0;e<4;e++)l.push(...c),c=c.map(s);for(let e=0;e<l.length;e++)o.push({a:l[e],b:l[(e+1)%l.length]});let u={x:a,z:a},d={x:i,z:i};for(let e=0;e<4;e++)o.push({a:u,b:d}),u=s(u),d=s(d);return o}function Ad(e,t,n){t!==void 0&&(e.envMap=t,e.envMapIntensity=n)}var jd=6,Md=4,Nd=5;function Pd(e,t,n){let r=new fa(P.half*2,Md,P.half*2),i=r.attributes.position.array,a=r.attributes.normal.array,o=r.attributes.uv.array,s=Array.from(r.index.array),c=i.length/3,l=Array.from(i),u=Array.from(a),d=Array.from(o),f=s.slice(),p=new X(e),m=new X(t),h=[];for(let e=0;e<c;e++)h.push(p.r,p.g,p.b);let g=Md/2+bd,_=yd/2;for(let e of n){let t=e.b.x-e.a.x,n=e.b.z-e.a.z,r=Math.hypot(t,n);if(r===0)continue;let i=t/r,a=n/r,o=e.a.x-i*_,s=e.a.z-a*_,c=e.b.x+i*_,p=e.b.z+a*_,v=-a*_,y=i*_,b=l.length/3;for(let[e,t]of[[o+v,s+y],[c+v,p+y],[c-v,p-y],[o-v,s-y]])l.push(e,g,t),u.push(0,1,0),d.push(0,0),h.push(m.r,m.g,m.b);f.push(b,b+1,b+2,b,b+2,b+3)}let v=new _i;return v.setAttribute(`position`,new ni(new Float32Array(l),3)),v.setAttribute(`normal`,new ni(new Float32Array(u),3)),v.setAttribute(`uv`,new ni(new Float32Array(d),2)),v.setAttribute(`color`,new ni(new Float32Array(h),3)),v.setIndex(f),v}function Fd(e,t){let n=new hr,r=[],i=t?.feltColor??3111514,a=(t?.pattern??`auto`)===`off`?[]:kd(),o=Pd(i,vd(i),a),s=new wa({color:16777215,vertexColors:!0,roughness:.95,metalness:0});Ad(s,e,.2);let c=new Bi(o,s);c.name=`felt`,c.position.set(0,-2,0),n.add(c),r.push(o,s);let l=new wa({color:7031343,roughness:.8,metalness:0});Ad(l,e,.5),r.push(l);let u=P.half*2+12;for(let[e,t,i,a]of[[u,jd,0,-P.half-jd/2],[u,jd,0,P.half+jd/2],[jd,P.half*2,-P.half-jd/2,0],[jd,P.half*2,P.half+jd/2,0]]){let o=new fa(e,Nd,t),s=new Bi(o,l);s.position.set(i,-2,a),n.add(s),r.push(o)}let d=!1;return{object:n,dispose(){if(!d){d=!0;for(let e of r)e.dispose()}}}}var Id=Math.round(256*(M.h/M.w)),Ld=[...[`m`,`p`,`s`].flatMap(e=>[1,2,3,4,5,6,7,8,9].map(t=>({suit:e,rank:t}))),...[1,2,3,4,5,6,7].map(e=>({suit:`z`,rank:e})),...[`m`,`p`,`s`].map(e=>({suit:e,rank:0}))];function Rd(e){return e.rank===0?34+{m:0,p:1,s:2,z:0}[e.suit]:{m:0,p:9,s:18,z:27}[e.suit]+(e.rank-1)}function zd(e){let t=Rd(e),n=t%6,r=Math.floor(t/6);return{u:n/6,v:r/7,w:1/6,h:1/7}}function Bd(e){return`/assets/tiles/${me(e)}.svg`}var Vd=`/assets/tiles/Front.svg`,Hd=.85;async function Ud(e){let t=new Image;return t.src=e,await t.decode(),t}async function Wd(e){let t=document.createElement(`canvas`);t.width=1536,t.height=Id*7;let n=t.getContext(`2d`);if(n===null)throw Error(`아틀라스 2d 컨텍스트를 못 얻었다`);let r=await Ud(Vd);await Promise.all(e.map(async e=>{let i=zd(e),a=await Ud(Bd(e)),o=i.u*t.width,s=(1-i.v-i.h)*t.height;n.drawImage(r,o,s,256,Id);let c=256*Hd,l=Id*Hd;n.drawImage(a,o+38.400000000000006/2,s+(Id-l)/2,c,l)}));let i=new ca(t);return i.colorSpace=qt,i.generateMipmaps=!0,i.anisotropy=8,i}var Gd=v(I.assistRecommend,te),Kd=i(I.locked,te),qd=.12,Jd=.65,Yd=`tile-shadow`,Xd=.02,Zd=.55,Qd=[M.w/2,M.h/2,M.d/2],$d=[Qd[0]-qd,Qd[1]-qd,Qd[2]-qd],ef=Qd[2]-M.d*Jd,tf={px:0,nx:1,py:2,ny:3,face:4,back:5},nf=[[tf.nx,tf.px],[tf.ny,tf.py],[tf.back,tf.face]],rf=(e,t)=>nf[e][+(t>0)],af=(e,t)=>e===0?[t,0,0]:e===1?[0,t,0]:[0,0,t];function of(e,t,n,r,i){let a=[t[1][0]-t[0][0],t[1][1]-t[0][1],t[1][2]-t[0][2]],o=[t[2][0]-t[0][0],t[2][1]-t[0][1],t[2][2]-t[0][2]],s=a[1]*o[2]-a[2]*o[1],c=a[2]*o[0]-a[0]*o[2],l=a[0]*o[1]-a[1]*o[0],u=n[0][0]+n[1][0]+n[2][0],d=n[0][1]+n[1][1]+n[2][1],f=n[0][2]+n[1][2]+n[2][2],p=s*u+c*d+l*f<0?[0,2,1]:[0,1,2];for(let a of p)e.pos.push(t[a][0],t[a][1],t[a][2]),e.nrm.push(n[a][0],n[a][1],n[a][2]),e.uv.push(i[a][0],i[a][1]),e.col.push(r.r,r.g,r.b)}function sf(e,t,n,r,i){of(e,[t[0],t[1],t[2]],[n[0],n[1],n[2]],r,[i[0],i[1],i[2]]),of(e,[t[0],t[2],t[3]],[n[0],n[2],n[3]],r,[i[0],i[2],i[3]])}var cf=[0,0],lf=[cf,cf,cf,cf];function uf(e){let t=zd(e),n=[0,1,2,3,4,5].map(()=>({pos:[],nrm:[],uv:[],col:[]})),r=(e,n)=>[t.u+t.w*((e+Qd[0])/M.w),t.v+t.h*((n+Qd[1])/M.h)],i=e=>e>=ef?ql.ivory:ql.amber,a=[[ef,$d[2]],[-$d[2],ef]];for(let e of[-1,1]){let t=e*Qd[2],a=af(2,e),o=[[-$d[0],-$d[1],t],[$d[0],-$d[1],t],[$d[0],$d[1],t],[-$d[0],$d[1],t]],s=e>0?o.map(e=>r(e[0],e[1])):lf;sf(n[rf(2,e)],o,[a,a,a,a],i(t),s)}for(let e of[0,1]){let t=+(e===0);for(let r of[-1,1]){let o=af(e,r),s=n[rf(e,r)],c=$d[t],l=(n,i)=>{let a=[0,0,0];return a[e]=r*Qd[e],a[t]=n,a[2]=i,a};for(let[e,t]of a)sf(s,[l(-c,e),l(c,e),l(c,t),l(-c,t)],[o,o,o,o],i((e+t)/2),lf)}}for(let e=0;e<3;e++)for(let t=e+1;t<3;t++){let r=3-e-t;for(let o of[-1,1])for(let s of[-1,1]){let c=af(e,o),l=af(t,s),u=n[rf(e,o)],d=(n,i)=>{let a=[0,0,0];return a[e]=o*(n?Qd[e]:$d[e]),a[t]=s*(n?$d[t]:Qd[t]),a[r]=i,a},f=r===2?a:[[-$d[r],$d[r]]];for(let[e,t]of f){let n=[d(!0,e),d(!0,t),d(!1,t),d(!1,e)],a=r===2?(e+t)/2:n[0][2];sf(u,n,[c,c,l,l],i(a),lf)}}}for(let e of[-1,1])for(let t of[-1,1])for(let r of[-1,1]){let a=[e*Qd[0],t*$d[1],r*$d[2]],o=[e*$d[0],t*Qd[1],r*$d[2]],s=[e*$d[0],t*$d[1],r*Qd[2]];of(n[rf(0,e)],[a,o,s],[af(0,e),af(1,t),af(2,r)],i(r*$d[2]),[cf,cf,cf])}let o=new _i,s=[],c=[],l=[],u=[],d=0;for(let e=0;e<6;e++){let t=n[e],r=t.pos.length/3;s.push(...t.pos),c.push(...t.nrm),l.push(...t.uv),u.push(...t.col),o.addGroup(d,r,e),d+=r}return o.setAttribute(`position`,new ni(new Float32Array(s),3)),o.setAttribute(`normal`,new ni(new Float32Array(c),3)),o.setAttribute(`uv`,new ni(new Float32Array(l),2)),o.setAttribute(`color`,new ni(new Float32Array(u),3)),o}function df(e,t){let n=new hr,r=new Map,i=[],a=new Y,o=new bn,s=new K,c=new Zn,l=new K(1,1,1),u=new K(1,1,1),d=e=>{c.set(e.rot.x,e.rot.y,e.rot.z),o.setFromEuler(c),s.set(e.pos.x,e.pos.y,e.pos.z);let t=e.scale??1;return t===1?a.compose(s,o,l):a.compose(s,o,u.set(t,t,t))},f=new pa(1,1),p=new Qi(f,e.shadow,t);p.name=Yd,p.count=0,p.frustumCulled=!1,p.renderOrder=-1,n.add(p);let m=new Y,h=new bn().setFromEuler(new Zn(-Math.PI/2,0,0)),g=new K,_=new K,v=(e,t)=>{if(t===null||t.grounded===!1){m.makeScale(0,0,0),p.setMatrixAt(e,m);return}let n=d(t).elements,r=Math.abs(n[0])*M.w/2+Math.abs(n[4])*M.h/2+Math.abs(n[8])*M.d/2,i=Math.abs(n[2])*M.w/2+Math.abs(n[6])*M.h/2+Math.abs(n[10])*M.d/2;g.set(t.pos.x,Xd,t.pos.z),_.set(2*r+Zd*2,2*i+Zd*2,1),p.setMatrixAt(e,m.compose(g,h,_))},y=new X(.4,.4,.4),b=new X(1,1,1),x=new X(Gd),S=new X(te),C=new X(x.r/S.r,x.g/S.g,x.b/S.b),w=new X(C.r*y.r,C.g*y.g,C.b*y.b),T=new X(Kd),E=new X(te),D=new X(T.r/E.r,T.g/E.g,T.b/E.b),O=new X(1.15,.14,.135),k=e=>e.won===!0?O:e.lock===!0?D:e.seen===!0?e.dim===!0?w:C:e.dim===!0?y:b,A=i=>{let a=`${i.suit}${i.rank}`,o=r.get(a);if(o!==void 0)return o;let s=uf(i);s.setAttribute(`aShimmer`,new Wi(new Float32Array(t),1));let c=new Qi(s,[e.body,e.body,e.body,e.body,e.face,e.back],t);c.count=0,c.frustumCulled=!1,n.add(c);let l={mesh:c,geo:s};return r.set(a,l),l},ee=(e,t,n)=>{let r=e.geometry.getAttribute(`aShimmer`);r!==void 0&&(r.setX(t,+(n?.dora===!0)),r.needsUpdate=!0)},j=!1;return{object:n,setAll(e){if(e.length>t)throw Error(`타일 풀 용량 초과: ${e.length} > ${t}`);for(let{mesh:e}of r.values())e.count=0;i=[];for(let t of e){let{mesh:e}=A(t.kind),n=e.count;e.setMatrixAt(n,d(t)),e.setColorAt(n,k(t)),ee(e,n,t),e.count=n+1,v(i.length,t),i.push({mesh:e,slot:n})}p.count=e.length,p.instanceMatrix.needsUpdate=!0;for(let{mesh:e}of r.values())e.instanceMatrix.needsUpdate=!0,e.instanceColor!==null&&(e.instanceColor.needsUpdate=!0)},setOne(e,t){let n=i[e];n!==void 0&&(n.mesh.setMatrixAt(n.slot,d(t)),n.mesh.setColorAt(n.slot,k(t)),ee(n.mesh,n.slot,t),n.mesh.instanceMatrix.needsUpdate=!0,n.mesh.instanceColor!==null&&(n.mesh.instanceColor.needsUpdate=!0),v(e,t),p.instanceMatrix.needsUpdate=!0)},setHidden(e){let t=i[e];t!==void 0&&(t.mesh.setMatrixAt(t.slot,a.makeScale(0,0,0)),t.mesh.instanceMatrix.needsUpdate=!0,v(e,null),p.instanceMatrix.needsUpdate=!0)},clear(){if(!j){for(let{mesh:e,geo:t}of r.values())n.remove(e),t.dispose(),e.dispose();r.clear(),i=[],p.count=0,p.instanceMatrix.needsUpdate=!0}},count:()=>i.length,dispose(){if(!j){j=!0;for(let{mesh:e,geo:t}of r.values())t.dispose(),e.dispose();r.clear(),f.dispose(),p.dispose(),i=[]}}}}var ff=160,pf=class{sc;mats;pool;table;scoreboard;sticks;ripples;frames;layout=null;diff=null;tracks=[];reveals=[];stickRest=[];stickThrows=[];flourishes=[];riichiKeys=null;flourishPainted=new Map;ripplePainted=[];dealLatched=!1;dealFlying=!1;dealEndMs=null;dealSkipped=!1;wallRise=null;riseTargets=[];revealLatched=!1;revealFlying=!1;revealEndMs=null;revealSkipped=!1;hold=null;heldPainted=null;last=null;rafHandle=null;shimmerOn=!1;shimmerWake=null;shimmerAnchor=null;frameCount=0;disposed=!1;atlasSettled;constructor(e,t,n,r){this.frames=n?.frames??re(),this.sc=Su(e,t,n?.scene,r),this.mats=su(),this.pool=df(this.mats,ff),this.table=Fd(this.sc.environment),this.scoreboard=Mu(),this.sticks=zu(this.mats),this.ripples=sd(),this.sc.scene.add(this.table.object),this.sc.scene.add(this.pool.object),this.sc.scene.add(this.scoreboard.object),this.sc.scene.add(this.sticks.object),this.sc.scene.add(this.ripples.object),this.atlasSettled=(n?.atlas??Wd)(Ld).then(e=>{this.mats.setFaceMap(e),this.sc.render()}).catch(e=>{console.error(`[board3d] 타일 아틀라스 굽기 실패`,e)})}async warmUp(e,t,n){this.disposed||(this.update(e,t,n),this.layout=null,this.riichiKeys=[],this.last=null,await this.atlasSettled,!this.disposed&&(this.sc.render(),this.pool.clear(),this.sc.render()))}attach(e,t){this.disposed||(e.appendChild(this.sc.renderer.domElement),this.styleCanvas(t))}update(t,n,r,i,a,o,s){if(this.disposed)return;this.last={state:t,humanSeat:n,opts:r,dealBudgetMs:i,revealBudgetMs:a,riichiPushMs:o,riichiRippleMs:s};let c=this.frames.now(),l=e=>g(t,n,{...r,view:this.sc.view,...e?{deadWallJoined:!0}:{}}),u=he(t);u||(this.dealLatched=!1,this.dealFlying=!1,this.dealEndMs=null,this.dealSkipped=!1,this.wallRise=null,this.riseTargets=[]);let d=u&&!this.dealLatched&&(i??0)>0;d&&(this.dealLatched=!0);let f=l(this.dealLatched),p=this.dealFlying||d?F(f,n):f,m=e(i??0),h=d?le(i??0,c):null,_=d?xe(t,p,m.dealMs,c+m.riseMs):null;_===null?d&&!this.dealFlying&&(p=f):(this.dealFlying=!0,this.dealEndMs=_.endMs,this.dealSkipped=!1,this.wallRise=h);let v=(r?.reveal?.size??0)>0;v||(this.revealLatched=!1,this.revealFlying=!1,this.revealEndMs=null,this.revealSkipped=!1);let y=v&&!this.revealLatched&&(a??0)>0&&this.layout!==null;y&&(this.revealLatched=!0);let b=y&&this.layout!==null?_u(this.layout,p,[...r?.reveal?.keys()??[]],a??0,c):null;b!==null&&(this.revealFlying=!0,this.revealEndMs=b.endMs,this.revealSkipped=!1);let x=fu(this.layout,p);this.diff=x;let S=r?.lessonMode===!0;this.scoreboard.object.visible=!S,S||this.scoreboard.update(k(t,n)),this.stickThrows=dd(this.layout?.sticks??null,p.sticks,this.stickThrows,c),this.stickRest=p.sticks,this.paintSticks(c),this.pool.setAll(p.tiles);let C=new Map(p.tiles.map((e,t)=>[e,t])),w=new Map(p.tiles.map(e=>[e.key,e])),T=this.tracks.map(e=>e.track),E=_===null?b?.tracks:_.tracks,D=E===void 0?pe(ve(x,c),T,c):[...E],O=E===void 0?[...D,...ie(D,T,c,w)]:D,A=O.flatMap(e=>{let t=C.get(e.to);return t===void 0?[]:[{index:t,track:e}]}),ee=Vu(t),te=e=>{let t=A.find(t=>t.track.to.key===e);return t===void 0?c:t.track.startMs+t.track.durMs};this.flourishes=Hu(this.riichiKeys,ee,this.flourishes,te,c,o??0,s??0),this.riichiKeys=ee.map(e=>e.key),this.riseTargets=ne(this.wallRise,c)?[]:[...p.tiles.flatMap(e=>e.zone===`wall`||e.zone===`dora`?[{index:C.get(e),rest:e,onWall:!0}]:[]),...A.map(e=>({index:e.index,rest:e.track.from,onWall:!1}))];let j=E===void 0?this.carriedEntering(p,c,new Set(O.map(e=>e.to))):[],M=E===void 0?oe([...x.enter,...j],O,c).flatMap(e=>{let t=C.get(e.tile);return t===void 0||e.atMs<=c?[]:[{index:t,reveal:e}]}):[];if(this.layout=p,this.shimmerOn=p.tiles.some(e=>e.dora===!0),this.shimmerAnchor=null,this.clearShimmerWake(),A.length===0&&M.length===0&&pd(this.stickThrows,c)&&Ju(this.flourishes,c)){if(this.stopLoop(),this.dealFlying){this.closeDeal();return}this.closeReveal(),this.paintRipples(c),this.paintHold(),this.paintShimmer(c),this.sc.render(),this.armShimmer(c);return}this.tracks=A,this.reveals=M,this.paint(c),this.startLoop()}dealHoldMs(){return!this.dealFlying||this.dealSkipped||this.dealEndMs===null?0:Math.max(0,this.dealEndMs-this.frames.now())}skipDeal(){if(this.disposed||!this.dealFlying||this.dealSkipped)return!1;let e=this.frames.now();this.wallRise=b(this.wallRise,e);let t=this.wallRise===null?e:this.wallRise.startMs+this.wallRise.durMs,n=[];for(let r of this.tracks){let[i]=ee([r.track],e);i!==void 0&&n.push({index:r.index,track:{...i,startMs:t}})}return this.tracks=n,this.dealSkipped=!0,this.dealEndMs=t+140,this.paint(e),this.startLoop(),!0}closeDeal(){if(!this.dealFlying)return;this.dealFlying=!1,this.dealEndMs=null,this.dealSkipped=!1,this.wallRise=null,this.riseTargets=[];let e=this.last;if(e===null){this.sc.render();return}this.update(e.state,e.humanSeat,e.opts,e.dealBudgetMs,e.revealBudgetMs,e.riichiPushMs,e.riichiRippleMs)}revealHoldMs(){return!this.revealFlying||this.revealSkipped||this.revealEndMs===null?0:Math.max(0,this.revealEndMs-this.frames.now())}skipReveal(){if(this.disposed||!this.revealFlying||this.revealSkipped)return!1;let e=this.frames.now(),t=[];for(let n of this.tracks){let[r]=vu([n.track],e);r!==void 0&&t.push({index:n.index,track:r})}return this.tracks=t,this.revealSkipped=!0,this.revealEndMs=e+140,this.paint(e),this.startLoop(),!0}closeReveal(){this.revealFlying&&(this.revealFlying=!1,this.revealEndMs=null,this.revealSkipped=!1)}carriedEntering(e,t,n){if(this.reveals.length===0)return[];let r=new Map(e.tiles.map(e=>[e.key,e])),i=[];for(let{reveal:e}of this.reveals){if(t>=e.atMs)continue;let a=r.get(e.tile.key);a===void 0||n.has(a)||a.kind.suit===e.tile.kind.suit&&a.kind.rank===e.tile.kind.rank&&i.push(a)}return i}paint(e){this.paintShimmer(e),this.paintSticks(e);for(let{index:t,track:n}of this.tracks)this.pool.setOne(t,j(n,e));if(!ne(this.wallRise,e))for(let{index:t,rest:n}of this.riseTargets)this.pool.setOne(t,Se(this.wallRise,n,e));else if(this.riseTargets.length>0){for(let{index:e,rest:t,onWall:n}of this.riseTargets)n&&this.pool.setOne(e,t);this.riseTargets=[]}for(let{index:t,reveal:n}of this.reveals)e>=n.atMs?this.pool.setOne(t,n.tile):this.pool.setHidden(t);this.paintFlourish(e),this.paintRipples(e),this.paintHold(),this.sc.render()}paintFlourish(e){if(this.flourishPainted.clear(),this.flourishes.length===0)return;let t=this.layout?.tiles;if(t!==void 0)for(let n of this.flourishes){let r=t.findIndex(e=>e.key===n.key),i=t[r];if(i===void 0||this.reveals.some(t=>t.index===r&&e<t.reveal.atMs))continue;let a=this.tracks.find(e=>e.index===r),o=Wu(a===void 0?i:j(a.track,e),n,e);this.pool.setOne(r,o),this.flourishPainted.set(n.key,o)}}paintRipples(e){let t=this.layout?.tiles,n=[];for(let r of this.flourishes){let i=Qu(r,e);if(i===null)continue;let a=t?.find(e=>e.key===r.key);a!==void 0&&n.push({x:a.pos.x,z:a.pos.z,radiusCm:i.radiusCm,glow:i.glow})}this.ripples.update(n),this.ripplePainted=n}flourishTile(e){return this.flourishPainted.get(e)??null}paintedRipples(){return this.ripplePainted}paintHold(){let e=this.hold,t=this.layout;if(e===null||t===null)return;let n=t.heldTileIndex;if(n===void 0)return;let r=t.tiles[n];if(r===void 0)return;let i={...r,pos:{x:e.at.x+e.grab.x,y:e.at.y+e.grab.y,z:e.at.z+e.grab.z}};this.pool.setOne(n,i),this.heldPainted=i}setHandDrag(e){if(this.disposed)return;if(e===null){this.endHold();return}let t=this.layout;if(t===null)return;let n=t.heldTileIndex;if(n===void 0)return;let r=t.tiles[n];if(r===void 0)return;let i=this.bandPointAt(e.pointer,e.size);if(i===null)return;let a=this.hold?.grab;if(a===void 0){let t=this.bandPointAt(e.origin,e.size);if(t===null)return;a={x:r.pos.x-t.x,y:r.pos.y-t.y,z:r.pos.z-t.z}}this.hold={at:i,grab:a},this.paintHold(),this.sc.render()}endHold(){let e=this.heldPainted,t=this.layout;if(this.hold=null,this.heldPainted=null,e===null||t===null)return;let n=t.heldTileIndex;if(n===void 0)return;let r=[...t.tiles];r[n]=e,this.layout={...t,tiles:r}}bandPointAt(e,t){let n=this.layout;if(n===null)return null;let r=this.sc.camera,i=e.x/t.w*2-1,a=-(e.y/t.h*2-1),o=new K(i,a,.5).unproject(r),s=this.sc.view.mode===`2d`?new K(i,a,-1).unproject(r):r.position;return N(n.handBand,{x:s.x,y:s.y,z:s.z},{x:o.x-s.x,y:o.y-s.y,z:o.z-s.z})}heldTile(){return this.heldPainted}paintSticks(e){this.sticks.update(fd(this.stickRest,this.stickThrows,e))}paintShimmer(e){let t=this.shimmerAnchor;this.mats.setShimmer(this.shimmerOn&&t!==null?Wl(e-t):-1)}startLoop(){this.rafHandle!==null||this.disposed||(this.rafHandle=this.frames.request(()=>{this.tick()}))}tick(){if(this.rafHandle=null,this.disposed)return;this.frameCount++;let e=this.frames.now();if(this.paint(e),we(this.tracks.map(e=>e.track),e)&&ce(this.reveals.map(e=>e.reveal),e)&&pd(this.stickThrows,e)&&Ju(this.flourishes,e)){this.tracks=[],this.reveals=[],this.stickThrows=[],this.flourishes=[],this.closeDeal(),this.closeReveal(),this.armShimmer(e);return}this.startLoop()}armShimmer(e){if(this.clearShimmerWake(),this.disposed||!this.shimmerOn)return;this.shimmerAnchor??=e;let t=e-this.shimmerAnchor;if(Gl(t)){this.startLoop();return}this.shimmerWake=this.frames.after(Kl(t),()=>{this.shimmerWake=null,this.startLoop()})}clearShimmerWake(){this.shimmerWake!==null&&(this.frames.clearAfter(this.shimmerWake),this.shimmerWake=null)}stopLoop(){this.rafHandle!==null&&(this.frames.cancel(this.rafHandle),this.rafHandle=null),this.clearShimmerWake(),this.tracks=[],this.reveals=[],this.stickThrows=[],this.flourishes=[],this.flourishPainted.clear(),this.ripplePainted=[]}resize(e,t){this.disposed||(this.sc.resize(e,t),this.last===null?this.sc.render():this.update(this.last.state,this.last.humanSeat,this.last.opts,this.last.dealBudgetMs,this.last.revealBudgetMs,this.last.riichiPushMs,this.last.riichiRippleMs))}currentLayout(){return this.layout}currentView(){return this.sc.view}lastDiff(){return this.diff}animStats(){let e=this.frames.now(),t=new Set(this.tracks.map(e=>e.index)),n=yu(this.revealFlying?this.tracks.map(e=>e.track):[],e),r=ae(this.dealFlying?this.tracks.map(e=>e.track):[],e);return{tracks:this.tracks.length,dealFlying:this.dealFlying,dealHoldMs:this.dealHoldMs(),dealAtWall:r.atWall,dealMoving:r.flying,riseSinkCm:_e(this.wallRise,e),riseTargets:this.riseTargets.length,riichiPushing:this.flourishes.filter(t=>e<Gu(t)).length,riichiLandInMs:this.flourishes.length===0?0:Math.max(0,this.flourishes[0].landMs-e),riichiPushEndInMs:this.flourishes.length===0?0:Math.max(0,Gu(this.flourishes[0])-e),riichiRippling:this.ripplePainted.length,riichiRippleRadiusCm:this.ripplePainted[0]?.radiusCm??0,riichiRippleGlow:this.ripplePainted[0]?.glow??0,revealFlying:this.revealFlying,revealHoldMs:this.revealHoldMs(),revealPending:n.pending,revealMoving:n.flying,revealLanded:n.landed,looping:this.rafHandle!==null,shimmerWake:this.shimmerWake!==null,shimmerU:this.shimmerOn&&this.shimmerAnchor!==null?Wl(e-this.shimmerAnchor):-1,frames:this.frameCount,waiting:this.reveals.filter(t=>e<t.reveal.atMs).length,hiddenMoving:this.reveals.filter(n=>e<n.reveal.atMs&&t.has(n.index)).length,sticksThrowing:this.stickThrows.filter(t=>!pd([t],e)).length}}overlaps(){return this.layout===null?-1:z(this.layout.tiles.map(m)).length}project(e,t){let{x:n,y:r}=this.projectDepth(e,t);return{x:n,y:r}}projectDepth(e,t){let n=new K(e.x,e.y,e.z).project(this.sc.camera);return{x:(n.x+1)/2*t.w,y:(1-n.y)/2*t.h,z:n.z}}contract(e,r,i){let a=this.layout;if(a===null)return null;let s={w:e.w-r.left-r.right,h:e.h-r.top-r.bottom};if(s.w<=0||s.h<=0)return null;let c=e=>({x0:e.x0-r.left,x1:e.x1-r.left,y0:e.y0-r.top,y1:e.y1-r.top}),l=this.last?.humanSeat??0,f=t=>{let n=t.map(t=>this.project(t,e));return{x0:Math.min(...n.map(e=>e.x))-r.left,x1:Math.max(...n.map(e=>e.x))-r.left,y0:Math.min(...n.map(e=>e.y))-r.top,y1:Math.max(...n.map(e=>e.y))-r.top}},g=e=>this.sc.view.mode===`2d`&&e.zone===`dora`?2:(e.seat-l+4)%4,v=a.tiles.map(e=>({rel:g(e),zone:e.zone,rect:f(x(m(e)))}));if(this.sc.view.mode!==`2d`){let e=_;for(let t of[0,1,2,3]){let n=(t+l)%4;v.push({rel:t,zone:`wall`,rect:f([e.zFar,e.zNear].flatMap(t=>[-e.halfX,e.halfX].flatMap(r=>[0,e.yTop].map(e=>p(n,{x:r,y:e,z:t})))))})}}for(let e of[1,2,3]){let t=(e+l)%4;v.push({rel:e,zone:`rowslot`,rect:f(w(t,this.sc.view))}),v.push({rel:e,zone:`pondmax`,rect:f(n(t))}),v.push({rel:e,zone:`pondhead`,rect:f(S(t))})}for(let e of[0,1,2,3]){let t=(e+l)%4;v.push({rel:e,zone:`callout`,rect:f([p(t,{x:0,y:0,z:o})])})}v.push({rel:0,zone:`handband`,rect:f(h(this.sc.view))});for(let e of[0,1,2,3]){let t=(e+l)%4;v.push({rel:e,zone:`meldmax`,rect:f(y(t,this.sc.view,e===0?u(this.sc.view):void 0))})}let b=D(d.half),C=f([{x:-b,y:0,z:-b},{x:b,y:0,z:-b},{x:-b,y:0,z:b},{x:b,y:0,z:b}]),T=i?.cards===void 0?void 0:Object.fromEntries(Object.entries(i.cards).map(([e,t])=>[e,c(t)])),O=[0,1,2,3].filter(e=>de(this.sc.view,(e+l)%4,e===0)),k=[0,1,2,3].filter(e=>t(this.sc.view,(e+l)%4,e===0));return E({samples:v,core:C,safe:s,cards:T,reserved:i?.reserved?.map(c),...this.currentView().mode===`2d`?{flat:!0}:{},...O.length>0?{pinnedCards:O}:{},...k.length>0?{rightCards:k}:{}})}handHitBoxes(e){let t=this.layout;return t===null?null:Te(t.tiles,this.last?.humanSeat??0,t=>this.projectDepth(t,e))}rendererInfo(){let e=this.sc.renderer.info;return{geometries:e?.memory.geometries??-1,textures:e?.memory.textures??-1,calls:e?.render?.calls??-1,triangles:e?.render?.triangles??-1}}render(){this.sc.render()}camera(){return this.sc.camera}dispose(){this.disposed||(this.disposed=!0,this.stopLoop(),this.pool.dispose(),this.table.dispose(),this.scoreboard.dispose(),this.sticks.dispose(),this.ripples.dispose(),this.mats.dispose(),this.sc.dispose())}styleCanvas(e){let t=this.sc.renderer.domElement.style;t?.setProperty(`pointer-events`,f(e)),t?.setProperty(`touch-action`,ye(this.sc.view.surface,e))}};export{pf as Board3D};